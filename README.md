...
So if you want to solve a _Calculs ||_ problem that was from this _specific book_ and it's difficulty is only _+-100 points_ away from your rating, you could do so.
